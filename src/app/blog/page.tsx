...
precision of modern engineering.</p>
     ...
     <div className='border-1 border-[#C5C9AD] rounded p-5 flex  gap-3 bg-white w-full mt-3 mb-3'>
       <div className='w-[50%] rounded border-1 relative'>
        <img src={featuredPost?.cover} alt="blogpost image w-full" />
       </div>
       <div className='flex flex-col gap-3'>
         ...
         <h2 className='text-[24px] font-bold'>{featuredPost?.title}</h2>
