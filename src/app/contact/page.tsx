...
const page = () => {
  ...
  <p className='text-[#444934]'>
    Whether you have a question about a project, a job opportunity, or just want
    to say hi, my inbox is always open. I'll get back to you as soon as possible.
  </p>
      ...
      <div className='w-full border-[#C5C9AD] border-1 self-start p-3'>
        <div className='p-3 bg-white w-full h-[180px] md:h-[200px] rounded overflow-hidden mb-4'>
          <iframe
            ...
            className="w-full h-full border-0 transition-transform duration-300 hover:scale-110"
            loading="lazy"
